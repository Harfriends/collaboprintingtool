...
public class PrintPdf {
	...
	*/
	 ...
	 */
	public PrintPdf(InputStream inputStream, String jobName, PageFormat pf) throws IOException, PrinterException {
	 ...
	 * @throws PrinterException
	 */
	public PrintPdf(byte[] content, String jobName, PageFormat pf) throws IOException, PrinterException {
		initialize(content, jobName, pf);
	}
	...
	private void initialize(byte[] pdfContent, String jobName, PageFormat pf) throws IOException, PrinterException {
		...
		//paper.setImageableArea(0, 0, 612.0, 792.0);
		paper.setImageableArea(0,0,595.275590551181, 841.8897637795275);
		pf.setPaper(paper);
	}

	public void print() throws PrinterException {
		// Send print job to default printer
		System.out.println("attempting print");
		pjob.print();
	}
}
